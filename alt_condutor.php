         ...
         <div class="row">
            <div class="col-xs-12 col-md-10 col-md-offset-1">
              ...
              <div class="col-xs-12 col-sm-8 col-md-10">
                <h1 class="page-header">Alterar condutor</h1>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div id="pgu-form" class="form-group">
                    <p class="formu-letra">PGU</p>
                    <input class="form-control pgu" type="text" name="pgu" id="pgu" maxlength="14" value="<?php print $pgu; ?>"/>
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-12">
                  <button class="btn btn-success btn-right" id="condutor-salvar" type="button">Salvar</button> 
