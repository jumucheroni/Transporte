                    ...
                    <p class="formu-letra">Condução</p>
                     ...
                     <option></option>
                      <?php while ($conducaorow = @mysqli_fetch_array($conducaoresult)){ 
                        ...
                        <option <?php if ($cpf_condutor == $conducaorow['cpf_condutor'] && $placa_veiculo == $conducaorow['placa_veiculo'] && $periodo == $conducaorow['periodo'])  { echo 'selected="true"'; } ?> value="<?php print $conducaorow['cpf_condutor'].';'.$conducaorow['placa_veiculo'].';'.$conducaorow['periodo'];?>"><?php print $conducaorow['cpf_condutor']."-".$conducaorow['placa_veiculo']."-".$p_conducao;?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
                    ...
                    <p class="formu-letra">Escola</p>
                     ...
                     <option></option>
                      <?php while ($escolarow = @mysqli_fetch_array($escolaresult)){ ?>
                        <option <?php if ($escola == $escolarow['id'])  { echo 'selected="true"'; } ?> value="<?php print $escolarow['id'];?>"><?php print $escolarow['nome'];?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
